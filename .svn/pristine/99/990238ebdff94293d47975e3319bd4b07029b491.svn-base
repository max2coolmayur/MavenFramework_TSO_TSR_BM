...
public class PD4_main_Locators {
	...
	public final String admin_systemActionsButton = "//div[starts-with(@id,'toolbar') and contains(@class,'x-toolbar-default')]//a//span[contains(text(),'System')]";//"//div[starts-with(@id,'toolbar') and contains(@class,'x-toolbar-default')]//span[text()=' System']";
	...
	public final String admin_Model_gradingNScoringButton="//div[contains(@id,'MainGrid')]//span[contains(text(),'Grading+Scoring')]";//"//div[contains(@id,'MainGrid')]//span[contains(text(),'G+S')]";//"//a//span[text()='G+S']";
	...
	public final String rowTitleOptions_sortAscending = "//span[text()='Sort Ascending']";//"css=span:contains('Sort Ascending')";
	public final String rowTitleOptions_sortDescending = "//span[text()='Sort Descending']";//"css=span:contains('Sort Descending')";
	public final String rowTitleOptions_showInGroups = "//a/span[text()='Show in Groups']";//a[contains(@id,'menucheckitem') and contains(@class,'x-menu-item-link')]/span[contains(@id,'menucheckitem') and contains(text(),'Show in groups')]/..";//"css=span:contains('Show in Groups')";
	public final String rowTitleOptions_showInGroups_checked = "//div[contains(@class,'x-menu-item-checked')]/a/span[text()='Show in Groups']";
	...
	public final String nameRowTitleOptions_groupByThisField = "//a/span[text()='Group By This Field']";
	...
	public final String ascSortOrder = "//div[contains(@id,'menu')]//span[contains(@id,'menuitem') and contains(text(),'Sort Ascending')]";
	public final String descSortOrder = "//div[contains(@id,'menu')]//span[contains(@id,'menuitem') and contains(text(),'Sort Descending')]";
	...
	public final String firstPageButton = "//a[@data-qtip='First Page']//span[contains(@class,'x-tbar-page-first')]";
	public final String previousPageButton = "//a[@data-qtip='Previous Page']//span[contains(@class,'x-tbar-page-prev')]";
	public final String nextPageButton = "//a[@data-qtip='Next Page']//span[contains(@class,'x-tbar-page-next')]"; 
	public final String lastPageButton = "//a[@data-qtip='Last Page']//span[contains(@class,'x-tbar-page-last')]";
...
//		return "//table/tbody/tr/td//div[contains(text(),'"+itemText+"')]";
		...
		if(BrowserFactory.verifyElementPresent("//table/tbody/tr/td//div[contains(text(),'"+itemText+"')]", 5)){
			return "//table/tbody/tr/td//div[contains(text(),'"+itemText+"')]";
		}else{
			return "//table/tbody/tr/td//span[contains(text(),'"+itemText+"')]";
	...
	public final String WarningWithTextBatchesWithoutTargLang ="//div[contains(text(),'There are batches without target languages')]";//div[contains(@id,'panel') and contains(@class,'x-panel-body-default')][text()='There are batches without target languages'];
