...
public final String tsr_translationTab_status_Column_VerifySegment_Image_Icon(int PartNo){
	...
	public final String tsrtab_segmentHistoryTab_checkDetails(int rowNumber,String segmentText) throws Exception{
		if(BrowserFactory.verifyElementPresent("//div[contains(@id,'reviewhistory')]//table[contains(@id,'view')]["+rowNumber+"]//td//div[contains(text(),'"+segmentText+"')]",5)==true){
	...
	public final String translationTab_Filter_drop_down_list_options(String list_option) throws Exception{
		if(BrowserFactory.verifyElementPresent("//div[contains(@name,'filter-boundlist')]//div//li[contains(text(),'"+list_option+"')]", 5)) {
...
//Sprint 22	
	...
	public final String translationTab_copyAllSourceButton() throws Exception{
		if(BrowserFactory.verifyElementPresent(TSO_main_Locators.exts().translationTab_copySourceButton_disabled, 5)){
	...
	public final String tsr_dashboard_transStudio4Tab_currentProject_button_X() throws Exception{
		if(BrowserFactory.verifyElementPresent("//a[contains(@class,'focus')]//div[contains(@class,'currentproject')]",5)==true){
	...
	//General Button Verification below Tab
		...
		public final String tsr_whitespace_symbol_iframe () throws Exception{
			...
			else if (BrowserFactory.verifyElementPresent("//html//body//div[contains(@style,'WscFont, SpaceFont')]",10)==true) {
